...
namespace Dx.Runtime.Tests.Data
{
    ...
    [Serializable]
    public class PreprocessedGenericTypeAndMethod<T1, T2> : ITransparent, ISerializable
    {
        ...
        protected PreprocessedGenericTypeAndMethod(SerializationInfo info, StreamingContext context)
        {
