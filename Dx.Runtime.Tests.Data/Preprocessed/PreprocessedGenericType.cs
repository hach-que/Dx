...
namespace Dx.Runtime.Tests.Data
{
    ...
    [Serializable]
    public class PreprocessedGenericType<T1, T2, T3> : ITransparent, ISerializable
    {
        ...
        protected PreprocessedGenericType(SerializationInfo info, StreamingContext context)
        {
